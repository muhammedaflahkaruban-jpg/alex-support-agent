...
function toast({ ...props }: Toast) {
  ...
  return {
    id: id,
    dismiss: () => memoizedDispatch({ type: actionTypes.DISMISS_TOAST, toastId: id }),
    update: (props: Partial<ToasterToast>) =>
      memoizedDispatch({ type: actionTypes.UPDATE_TOAST, toast: { ...props, id } }),
  }
}
...
function useToast() {
  ...
  return {
    ...
    dismiss: React.useCallback(function dismiss(toastId?: string) {
      memoizedDispatch({ type: actionTypes.DISMISS_TOAST, toastId })
    }, []),
  }
}
